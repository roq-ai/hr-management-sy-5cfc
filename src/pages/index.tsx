  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Navigate Your Workforce with Ease Using HR Management System: Centralizing Employee Data, Payroll, Time Tracking, Vacations, and Performance Evaluations."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Navigate Your Workforce with Ease Using HR Management System: Centralizing Employee Data, Payroll, Time Tracking, Vacations, and Performance Evaluations.`}
            </Text>
            <Box
